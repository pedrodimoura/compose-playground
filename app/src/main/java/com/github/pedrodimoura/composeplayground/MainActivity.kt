package com.github.pedrodimoura.composeplayground
...
import com.github.pedrodimoura.composeplayground.ui.theme.ComposePlaygroundTheme
...
private fun MyApp() {
    ...
    when {
        shouldShowOnboarding -> OnboardingScreen(onContinuedClicked = {
    ...
    Surface {
        Column(
            ...
            Button(
                ...
                Text(text = stringResource(id = R.string.continue_to_playground))
            }
        }
    }
}
